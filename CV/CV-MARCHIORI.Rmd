...
- Microsoft Certified Azure Machine Learning Data Scientist Associate, proficient in Docker, Azure MLOps, CI/CD, Posit Connect.
...
tribble(
  ...
  "SENIOR DATA SCIENTIST", "", "Sydney, Australia", "Oct 2019 - Apr 2021", "Vegetation management optimisation to reduce > 5% OPEX on multi-million dollar maintainence budget.",
  "SENIOR DATA SCIENTIST", "", "Sydney, Australia", "Oct 2019 - Apr 2021", "Developed and deployed a machine learning model to predict the imapct of severe storms on the electricty grid with >90% accuracy.",
...
tribble(
  ...
  "BACHELOT OF SCIENCE (MATHEMATICS)", "Charles Sturt University", "Bathurst, Australia", "2013 - 2017", "Statistics Minor",
...
tribble(
  ...
  "CHAIR", "Statistical Society of Australia", "Australia", "2025", "Chair of the Data Science and Accrediation Working Group",
